# -*- coding: utf-8 -*-
{
    ...
    'images': [
        ...
        'static/description/screenshots/screenshot_backend.png',
        'static/description/screenshots/screenshot_pos_popup.png',
        'static/description/screenshots/screenshot_pos_menu.png',
        'static/description/screenshots/screenshot_product_list.png',
    ],
    'demo': [],
    'installable': True,
    'application': False,
